...
If `reviews/adventure-report.md` exists (generated by `/adventure-review`), note: "Review synthesis available at `.agent/adventures/{ADV-ID}/reviews/adventure-report.md`"
